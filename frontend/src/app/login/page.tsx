...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#030303] overflow-hidden px-4 selection:bg-purple-500 selection:text-white">
      {/* Minimal Dark Background Image Overlay */}
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-purple-600/15 rounded-full blur-[140px] pointer-events-none z-0" />
      <div className="absolute bottom-1/4 right-1/4 w-[350px] h-[350px] bg-blue-600/10 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 w-full max-w-md p-8 sm:p-10 rounded-2xl bg-black/60 border border-white/10 shadow-2xl backdrop-blur-xl text-center space-y-8">
        ...
        <div className="space-y-3.5 pt-2">
          ...
          <div className="relative flex items-center py-1">
            ...
            <span className="flex-shrink mx-4 text-[11px] uppercase tracking-wider text-gray-500 font-semibold">Or continue with</span>
            <div className="flex-grow border-t border-white/10" />
          </div>
      ...
      {showGoogleModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
          <div className="w-full max-w-sm p-6 rounded-2xl bg-zinc-950 border border-white/10 shadow-2xl space-y-6">
            ...
            <form onSubmit={handleGoogleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-zinc-900 border border-white/10 text-sm text-white focus:outline-none focus:border-purple-500"
                />
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="button"
                  onClick={() => setShowGoogleModal(false)}
                  className="flex-1 py-2.5 bg-zinc-900 hover:bg-zinc-800 text-gray-300 text-xs font-semibold rounded-xl border border-white/10"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-2.5 bg-purple-600 hover:bg-purple-500 text-white text-xs font-semibold rounded-xl shadow-lg shadow-purple-900/30"
                >
