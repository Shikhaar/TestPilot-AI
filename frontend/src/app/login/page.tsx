  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#030303] px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 glass-panel p-8 text-center relative overflow-hidden">
        {/* Decorative glows */}
        <div className="absolute top-[-50%] left-[-50%] w-[100%] h-[100%] rounded-full bg-blue-900/10 blur-[80px] pointer-events-none" />
        ...
        <div className="mt-8 space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full flex justify-center items-center gap-3 px-4 py-3 bg-blue-700 hover:bg-blue-800 text-white font-semibold rounded-lg border border-blue-500/40 disabled:bg-gray-800 transition text-sm shadow-lg shadow-blue-900/30"
          >
            ...
            <span>{loading ? "Redirecting to GitHub..." : "Continue with GitHub OAuth"}</span>
          </button>
