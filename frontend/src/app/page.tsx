      ...
      <main className="flex-1 overflow-y-auto px-8 py-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 pb-6 border-b border-white/10">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="px-4 py-2 text-xs font-semibold text-white bg-blue-700 hover:bg-blue-800 border border-blue-500/40 rounded-lg shadow-lg shadow-blue-900/40 transition-all flex items-center space-x-2">
